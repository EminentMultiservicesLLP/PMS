...
namespace CommonDataLayer.DataAccess
{
    ...
    public class DBHelper :IDisposable
    {
        ...
        public DataTable ExecuteDataTableWithTimeout(string commandText, string tableName, DBParameterCollection paramCollection, IDbTransaction transaction, CommandType commandType, int Timeout)
        {
            DataTable dtReturn = new DataTable();
            IDbConnection connection = transaction != null ? transaction.Connection : _connectionManager.GetConnection();
            IDbCommand command = _commandBuilder.GetCommand(commandText, connection, paramCollection, commandType);
        ...
        public DataTable ExecuteDataTableWithTimeout(string commandText, DBParameterCollection paramCollection, CommandType commandType, int Timeout)
        {
            return ExecuteDataTableWithTimeout(commandText, string.Empty, paramCollection, _transaction, commandType, Timeout);
        }
        #endregion
